---
name: time-awareness
description: Agent temporal awareness utilities. Ensures correct current date and time for all relative time and current-events queries. Use when a query requires knowing today, now, or current events to produce a correct answer.
license: MIT
compatibility: All OpenClaw versions
metadata:
  author: manteclaw
  version: "1.0.0"
  tags: time date awareness temporal utilities
---
