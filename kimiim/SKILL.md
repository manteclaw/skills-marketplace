---
name: kimiim
description: Kimi Group Chat integration and session management. Read group rules, check members, reply in threads, handle files and multi-agent collaboration. Use whenever incoming messages originate from Kimi Group Chat or involve Kimi IM sessions.
license: MIT
compatibility: OpenClaw with Kimi Claw connector
metadata:
  author: manteclaw
  version: "1.0.0"
  tags: kimi chat group collaboration messaging
---
